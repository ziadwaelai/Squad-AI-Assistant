...
def process_text():
    ...
    try:
        ...
        prompt = f"""
انت مساعد ذكاء اصطناعي.
قم بمعالة النص التالي و قدم دي مناسب جداا للمستخدمين العرب: بطرية لطيفه و مريحه جداا و استخدم emojes 
النص: {selected_text}
ملحوظه رد واحد فقط و لا ترد باكثر من 100 كلمه
        """
